...
plotaccuracy.set_title("Diagram Akurasi")
plotaccuracy.plot(plotcounter, plotcorrecttrain, color="orange", label="training akurasi")
plotaccuracy.plot(plotcounter, plotcorrectvalidate, color="blue", label="validasi akurasi")
plotaccuracy.set_xlabel("jumlah epoch")
plotaccuracy.set_ylabel("persentase akurasi")
plotaccuracy.legend(loc="lower right")


len(ploterrortrain)
ploterror.set_title("Diagram Error")
ploterror.plot(plotcounter, ploterrortrain, color="orange", label="training error")
ploterror.plot(plotcounter, ploterrorvalidate, color="blue", label="validasi error")
ploterror.set_xlabel("jumlah epoch")
